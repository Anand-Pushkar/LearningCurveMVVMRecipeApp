package com.example.learningcurvemvvmrecipeapp.interactors.recipe
...
import com.example.learningcurvemvvmrecipeapp.network.data.MockWebServerResponses.recipeWithId1551
...
class GetRecipeTest {
    ...
    fun getRecipesFromNetwork_getRecipeById(): Unit = runBlocking {
        ...
        val searchResult = searchRecipes.execute(
